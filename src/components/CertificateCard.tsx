...
export default function CertificateCard({
  ...
  return (
    <div className="group bg-slate-900/50 border border-slate-800 hover:border-cyan-400/30 rounded-xl overflow-hidden transition-all duration-300 hover:-translate-y-1">
      <div
